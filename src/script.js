...
function preencher() {
  ...
  tbody.innerHTML += `<tr><td>${idAtual}</td><td>${nomeValue}</td><td>${descValue}</td><td><button class="buttonDelete" onclick="deleteItem('${idAtual}')">Deletar este anime</button></td></tr>`;
